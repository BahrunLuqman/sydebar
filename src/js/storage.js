...
(function() {
	...
	sydebar.Storage.updateCommon = function(common, callback) {
		var newObj = {};
	...
	sydebar.Storage.getCommon = function(callback) {
	...
	sydebar.Storage.updateUser = function(username, loadedSettings, callback) {
	...
	sydebar.Storage.updateUserBundles = function(
		username, user, userBundles, overwriteDr, callback
	) {
		var bundleObj = {};
		Object.keys(userBundles).forEach((deviceId) => {
	...
	sydebar.Storage.deleteUser = function(username, callback) {
	...
	sydebar.Storage.getUser = function(username, callback) {
